...
# 📚 Econ 106 Lecture Materials

Welcome to the course site for **Econ 106: Data Analysis in Economics**. Below you'll find materials for each lecture including slides, code, and summaries. Lecture HTML notes are being added on a rolling basis.

## Lectures

::: {.panel-group}

### 📘 Lecture 1: Introduction to R and RStudio {.panel}
...
### 📘 Lecture 2: Packages, Data Frames, and Summary Statistics {.panel}
...
### 📘 Lecture 3: Filtering Rows with Logical Conditions {.panel}
...
### 📘 Lecture 4: Mutating and Creating New Variables {.panel}
...
### 📘 Lecture 5: Data Visualization with ggplot2 {.panel}
...
### 📘 Lecture 6: Cleaning Numeric Variables {.panel}
...
### 📘 Lecture 7: Working with Strings and Dates {.panel}
...
### 📘 Lecture 8: Factors and Categorical Variables {.panel}
...
### 📘 Lecture 9: Visualizing Single Variables {.panel}
...
### 📘 Lecture 10: Comparing Variables with Visuals {.panel}
...
### 📘 Lecture 11: Tidy Data and Reshaping {.panel}
...
### 📘 Lecture 12: Joining Tables with dplyr {.panel}
...
### 📘 Lecture 13: Text Data I – Tokenization and Frequency {.panel}
...
### 📘 Lecture 14: Text Data II – Sentiment Analysis {.panel}
...
### 📘 Lecture 15: Mapping Spatial Data with sf {.panel}
...
### 📘 Lecture 16: Thematic Mapping and Color Scales {.panel}
...
### 📘 Lecture 17: Introduction to Spatial Data Layers {.panel}
...
### 📘 Lecture 18: Spatial Analysis with Regular Joins and Projections {.panel}
...
### 📘 Lecture 19: Final Project Workshop and Examples {.panel}

**Summary:**  
Prepares students for the final project by reviewing expectations, grading rubrics, and successful past examples. Emphasizes visual clarity, reproducibility, and storytelling with data. Includes live feedback and peer review guidance.
